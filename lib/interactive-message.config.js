  ...
  return plugin.grammar
    ...
    .then(async (v) => {
      ...
      return JSON.stringify(
        [
          {
            hint: "Surrounding it with an ` allows it. ",
            example: "Add myFunc -> Add `myFunc`",
          },
          r.map((e, i) => ({
            ...e,
            description: {
...
{{body}}`,
  questionDictionary: [
    ...
    },
    {
      ...
      overwriteAnswer: overwriteAnswerBodyFn("en-US"),
