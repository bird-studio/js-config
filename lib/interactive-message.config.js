...
const jsConfig = cosmiconfigSync("js-config").search()?.config;
...
const fetchMyIssues = () =>
  plugin.github
    .fetchIssues(jsConfig.fetchMyIssuesParam)
    .then((r) =>
      r.data
 ...
 */
const interactiveMessageConfig = {
...
module.exports = { interactiveMessageConfig };
